...
- [k] Build a second custom hook that sets the `dark-mode` class on the body element
- [k] Compose your two new hooks together to be able to set and persist your user's dark mode preference in your app
